...
interface StandItemDetailsDialogProps {
  name: string;
  image?: string;
  quantity?: number;
  colorNumber?: string;
...
export function StandItemDetailsDialog({
  name,
  image,
  quantity,
  colorNumber,
        ...
        <View style={styles.detailsContainer}>
          ...
          {colorNumber ? (
            <View style={[styles.detailRow, { backgroundColor: colors.surfaceSecondary }]}>
              ...
              <Text style={[styles.detailValue, { color: colors.text }]}>{colorNumber}</Text>
            </View>
          ) : null}
          ...
          {itemCode ? (
            <View style={[styles.detailRow, { backgroundColor: colors.surfaceSecondary }]}>
              <Text style={[styles.detailLabel, { color: colors.textSecondary }]}>
                {t.itemModal.itemCode}:
              </Text>
              <Text style={[styles.detailValue, { color: colors.text }]}>{itemCode}</Text>
            </View>
          ) : null}
